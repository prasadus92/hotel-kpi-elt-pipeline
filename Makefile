# Convenience targets for the RoomPriceGenie KPI pipeline.
...
dbt-test: ## Build dbt models and run dbt tests
	RPG_DUCKDB_PATH=$(CURDIR)/dbt/rpg_kpi/rpg.duckdb \
		$(VENV)/bin/dbt build --project-dir dbt/rpg_kpi --profiles-dir dbt/rpg_kpi \
...
clean: ## Remove generated artifacts
	rm -f dbt/rpg_kpi/rpg.duckdb dbt/rpg_kpi/rpg.duckdb.wal
	rm -rf dbt/rpg_kpi/target dbt/rpg_kpi/logs
