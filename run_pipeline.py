#!/usr/bin/env python3
"""hotel daily-KPI pipeline — CLI entrypoint.
...
DBT_PROJECT_DIR = REPO_ROOT / "dbt" / "hotel_kpi"
DEFAULT_INPUT = REPO_ROOT / "data" / "reservations_data.json"
DEFAULT_OUTPUT_DIR = REPO_ROOT / "output"
DUCKDB_PATH = DBT_PROJECT_DIR / "hotel_kpi.duckdb"
...
def run_dbt(hotel_id: str, from_date: str, to_date: str) -> None:
    ...
    env = {**os.environ, "HOTEL_KPI_DUCKDB_PATH": str(DUCKDB_PATH)}
...
def main(argv: list[str] | None = None) -> int:
    ...
    print("=" * 70)
    print(f"hotel KPI pipeline | hotel={args.hotel_id} "
